...
project = u'vault-redirector'
copyright = u'2016 Manheim'
author = u'Manheim/Jason Antman'
...
html_title = 'v{v} - redirect Hashicorp Vault client requests to the active node in a HA cluster'.format(v=version)
...
latex_documents = [
  (master_doc, 'vault-redirector.tex', u'vault-redirector Documentation',
   u'Manheim', 'manual'),
]
...
man_pages = [
    (master_doc, 'vault-redirector', u'vault-redirector Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'vault-redirector', u'vault-redirector Documentation',
   author, 'vault-redirector', 'redirect Hashicorp Vault client requests to the active node in a HA cluster',
   'Miscellaneous'),
]

...
.. image:: https://img.shields.io/github/issues/jantman/vault-redirector.svg
   :alt: GitHub Open Issues
   :target: https://github.com/jantman/vault-redirector/issues

 .. image:: http://www.repostatus.org/badges/latest/wip.svg
    :alt: Project Status: WIP – Initial development is in progress, but there has not yet been a stable, usable release suitable for the public.
    :target: http://www.repostatus.org/#wip

.. image:: https://secure.travis-ci.org/manheim/vault-redirector.png?branch=master
   :target: http://travis-ci.org/manheim/vault-redirector
   :alt: travis-ci for master branch

.. image:: https://codecov.io/github/manheim/vault-redirector/coverage.svg?branch=master
   :target: https://codecov.io/github/manheim/vault-redirector?branch=master
   :alt: coverage report for master branch

.. image:: https://readthedocs.org/projects/vault-redirector/badge/?version=latest
   :target: https://readthedocs.org/projects/vault-redirector/?badge=latest
